...
export default function RotatingEarth({ width = 800, height = 600, className = "" }: RotatingEarthProps) {
    ...
    return (
      <div className={`flex items-center justify-center bg-black/50 rounded-2xl p-8 ${className}`}>
        <div className="text-center">
          <p className="text-yellow-400 font-semibold mb-2">Globe unavailable</p>
  ...
  return (
    <div className={`relative ${className}`}>
      ...
      />
      <div className="absolute bottom-4 left-4 text-xs text-zinc-500 px-2 py-1 rounded-md bg-black/60 backdrop-blur-sm">
